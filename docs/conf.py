...
project = 'Forecaster Support Products for Analysis of Tropical Cyclone Intensity and Structure from Aircraft Reconnaissance Observations'
copyright = '2023, NCAR'
author = 'UCAR/NCAR, CSU, UM, NOAA'
author_list = 'Vigh, J. L., Bell, Michael M., Zhang, Jun A., Hendricks, Eric A., Rozoff, Christopher M., DesRosier, Alex J., DeHart, Jen C.'
version = '0.1'
verinfo = version
release = f'{version}'
release_year = '2024'

release_date = f'{release_year}-05-01'
