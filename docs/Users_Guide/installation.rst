...
Installation guide for SWIFT-OBT
================================

SWIFT-OBT consists of the integration of FLIGHT-RT, VDM-RT, TC-OBS-RT, SAMURAI and ?. It currently requires NCAR Command Language (NCL) and Python. The version numbers (when provided) indicate the *minimum* version number for that package.  Some plots may require additional packages that are not listed below.
